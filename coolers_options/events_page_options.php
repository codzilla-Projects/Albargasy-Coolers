<?php 
function events_content_area_callback() {
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 bg-gray mt-3 mb-3 rounded">
            ...
            <header class="codrops-header">
                <h1 class="text-center site-title"><span><?php _e('Events Page Settings', 'coolers'); ?></span></h1>
            </header>
        </div>
        <br/>
